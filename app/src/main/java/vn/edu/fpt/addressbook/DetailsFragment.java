...
public class DetailsFragment extends Fragment {
    ...
    private void deleteContact() {
        ...
        dialog.setContentView(R.layout.layout_dialog_submit);
        ...
        Button btnCancel = dialog.findViewById(R.id.btn_delete_cancel);
        Button btnOk = dialog.findViewById(R.id.btn_delete_ok);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                @SuppressLint("StaticFieldLeak") AsyncTask<Long, Object, Object> deleteTask =
